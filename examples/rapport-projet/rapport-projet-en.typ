...
#figure(
  algorigramme(
    ...
    algo-sous-programme("IMU Configuration", sous-titre: "±2g range, internal LPF"),
    algo-es("Read Accelerometer Registers", sous-titre: "Raw 6-byte I2C burst"),
    algo-decision("Valid Data", non: "Discard & Sleep"),
    "YES",
    algo-action("Compute Moving Average Filter", sous-titre: "FIR digital filtering"),
    algo-es("Transmit Radio Packet", sous-titre: "SX1276 LoRa payload"),
